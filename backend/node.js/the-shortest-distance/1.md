...
* **Stage 3**: 외부 시스템 통합 & 인프라 (N2.4-N2.6)
...
## 7. Stage 3 – 외부 시스템 통합 & 인프라 (N2.4-N2.6)

### 7.1 Stage 3의 목표

이 Stage는 **선택 사항**이다. N2.4-N2.5는 검색 엔진, 메시지 큐 같은 외부 시스템 통합을 경험하고 싶을 때, N2.6은 프로덕션 배포를 준비할 때 들어간다.
...
* **N2.6 - Production Infrastructure**
...
4. **문서 4 – 고급 패턴 II: 외부 시스템 & 인프라 (N2.4-N2.6)**
