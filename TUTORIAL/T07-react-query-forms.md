...
> **목표**: React Query와 React Hook Form으로 서버 상태 및 폼 처리 완전 정복
> **예상 시간**: 12-15시간 (주 6-8시간)
> **난이도**: 🟡 중급
> **선행 요구사항**: [T06: React/Vite 기본](./T06-react-vite-basics.md)
> **적용 프로젝트**: frontend/react M2-M3
> **퀄리티 보장**: 타입 안전 폼, 효율적 캐싱, 최적화된 렌더링
> **효율성 보장**: 실전 패턴, 단계별 구현, 퍼포먼스 팁
